...
namespace Abdelmneim.NoTenancy.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update NoTenancyDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update NoTenancyEfCoreEntityExtensionMappings to extend the IdentityUser entity
